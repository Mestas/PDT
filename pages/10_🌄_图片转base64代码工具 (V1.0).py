...
# 侧边栏说明介绍
st.sidebar.write("<h4 style='color: blue;'>本工具可以将bmp图片转化为base64代码</h4>", unsafe_allow_html=True)
# 工具名称、版本号
st.write("# PIC2code工具 #")
...
files = st.file_uploader("请上传bmp图片文件", accept_multiple_files=True, type=['bmp'], help="请选择bmp图片进行上传，可同时选择多个图片")

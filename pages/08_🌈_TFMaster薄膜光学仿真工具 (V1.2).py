...
if cal_button_clicked_ref:
    ...
    new_content = user_name + '于' + date + '使用了《08-TFMaster薄膜光学仿真工具 (V1.1) - 反射部分》;  ' + '\n'
...
if cal_button_clicked_trans:
    ...
    # 格式化时间
    date = local_time.strftime('%Y-%m-%d %H:%M:%S')
    new_content = user_name + '于' + date + '使用了《08-TFMaster薄膜光学仿真工具 (V1.1) - 透射部分》;  ' + '\n'
